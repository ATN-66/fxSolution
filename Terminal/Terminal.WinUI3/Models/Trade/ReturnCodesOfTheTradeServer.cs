...
public enum TradeRetCode
{
    ...
    InvalidCloseVolume = 10038,
    [Description("A close order already exists for a specified position")]
    CloseOrderExist = 10039,
    [Description("The number of open positions simultaneously present on an account can be limited by the server settings")]
    ...
    FifoClose = 10045,
    [Description("The request is rejected, because the 'Opposite positions on a single symbol are disabled' rule is set for the trading account")]
