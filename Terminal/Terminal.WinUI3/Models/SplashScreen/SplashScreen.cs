...
public class SplashScreen
{
    ...
    public void DisplaySplash(IntPtr hWnd, IntPtr hBitMap)
    {
        ...
        hWndSplash = CreateWindowEx(WS_EX_TOOLWINDOW | WS_EX_LAYERED | WS_EX_TRANSPARENT | WS_EX_TOPMOST | WS_EX_NOACTIVATE,
            sClassName, "Win32 window", WS_POPUP | WS_VISIBLE, xPos, yPos, nWidth, nHeight, hWnd, IntPtr.Zero, wcex.hInstance, IntPtr.Zero);

        // ... rest of your code

        //// ... all the previous code until window creation

        //// Get the monitor for the parent window
        //IntPtr hMonitor = MonitorFromWindow(hWnd, 0x00000002); // MONITOR_DEFAULTTONEAREST
        ...
        //// Calculate the center position for the splash screen on this monitor
        //int monitorWidth = mi.rcMonitor.right - mi.rcMonitor.left;
        //int monitorHeight = mi.rcMonitor.bottom - mi.rcMonitor.top;
        //int xPos = mi.rcMonitor.left + (monitorWidth - nWidth) / 2;
